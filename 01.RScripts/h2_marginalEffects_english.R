...
cme_h2t4 <- 
  ...
  ggtitle("A. Basic Education") + 
  labs(x = "Economic Globalization",
       y = "Educational Expenditure (% GDP)",
       colour = "Government Ideology Position", 
       fill = "Government Ideology Position", 
       linetype = "Government Ideology Position") + 
...
cme2_h2tw2 <-
  ...
  geom_ribbon(aes(ymin = conf.low,
              ...
              linewidth = 0.5) +
  ggtitle("A. Basic Education") +
  labs(x = "Government Ideology",
       y = "Effect of Globalization") +
  theme_apa(x.font.size = 10,
            y.font.size = 10) +
  theme(plot.title = element_text(size = 10),
        axis.text.x = element_text(color = "black",
